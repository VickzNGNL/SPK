...
class BaseMethod():
    ...
    def __init__(self):
        self.raw_weight = {'harga': 7, 'ram': 4, 'kapasitas_baterai': 3, 'chipset': 4, 'penyimpanan_internal': 2}
    ...
    @property
    def data(self):
        query = select(SmartphoneModel.id_smartphone, SmartphoneModel.harga, SmartphoneModel.ram, SmartphoneModel.kapasitas_baterai, SmartphoneModel.chipset, SmartphoneModel.penyimpanan_internal)
        result = session.execute(query).fetchall()
        print(result)
        return [{'id_smartphone': smartphone.id_smartphone, 'harga': smartphone.harga, 'ram': smartphone.ram, 'kapasitas_baterai': smartphone.kapasitas_baterai, 'chipset': smartphone.chipset, 'penyimpanan_internal': smartphone.penyimpanan_internal} for smartphone in result]
...
class WeightedProductCalculator(BaseMethod):
    ...
    def calculate(self):
        ...
        for product in sorted_produk:
            sorted_data.append({
                'id_smartphone': product['id_smartphone'],
...
class Smartphone(Resource):
    ...
    def get(self):
        ...
        data = [{'id_smartphone': smartphone.id_smartphone, 'harga': smartphone.harga, 'ram': smartphone.ram, 'kapasitas_baterai': smartphone.kapasitas_baterai, 'chipset': smartphone.chipset, 'penyimpanan_internal': smartphone.penyimpanan_internal} for smartphone in session.scalars(query)]
